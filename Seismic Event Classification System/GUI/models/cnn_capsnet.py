...
class CapsNet(nn.Module):
    ...
    def __init__(self,routing_iterations,model_choose,n_classes=3,out_dim=784,reconstructed=False):
        ...
        # if self.model_choose == 'res_capsnet':#stft7272
        #     self.num_primaryCaps = 19600
        if self.model_choose == 'res_capsnet':#mfcc4072
            self.num_primaryCaps = 10640
        #mfcc4072
        elif self.model_choose == 'cnn_capsnet':#mfcc4072
            self.num_primaryCaps = 9792
        # elif self.model_choose == 'cnn_capsnet':#stft7272
        #     self.num_primaryCaps = 18496
        ...
        elif self.model_choose == 'se_capsnet':#mfcc4072
            self.num_primaryCaps = 9792
...
def cnn_capsnet(model_choose,num_classes=3):
    model = CapsNet(model_choose=model_choose,routing_iterations=3,n_classes=num_classes,reconstructed=False)
