...
import time
import datetime
from data_loader import two_class_dataloader
...
def main():
    ...
    #数据根路径(1,2,3)
    dataset_id=3
    #数据集选择 ('1d','GADF','STFT_26_118','STFT_72_72','MFCC19_24','MFCC_36_72')
    dataset_choose='1d'
    #模型选择 (cnn1d,resnet1d,googlenet1d,vgg1d,alexnet1d,cnn2d,googlenet,alexnet,resnet18,vit,vit_small,swin,mult_cnn,vgg11,cnn_capsnet,res_capsnet,seres_capsnet,cct_capsnet,res18_capsnet)
    model_choose='resnet1d'
    ...
    if dataset_choose=='1d':
        ...
        train_loader,val_loader =two_class_dataloader(natural_train_path_0=base_path+'/processed_data/GADF/natural_train_GADF_0.pt',
                                        ...
                                        batch_size=Batch_size,validation_percentage=Validation_percentage)
    elif dataset_choose == 'STFT_26_118' or dataset_choose == 'STFT_72_72':
        train_loader,val_loader =two_class_dataloader(natural_train_path_0=base_path+'/processed_data/'+dataset_choose+'/natural_train_STFT.pt',
                                        ...
                                        batch_size=Batch_size,validation_percentage=Validation_percentage)
    elif dataset_choose=='MFCC_39_24' or dataset_choose == 'MFCC_36_72':
    ...
    for epoch in range(epochs):
        ...
        }, is_best,dataset_choose,model_choose,Batch_size,learning_rate,Weight_decay,checkpoint_path,Num_classes,order=0)
