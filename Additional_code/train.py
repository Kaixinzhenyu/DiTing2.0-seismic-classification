...
def main():
    ...
    #         cnn_capsnet,res_capsnet,seres_capsnet,res18_capsnet,cbam_capsnet,cbamres_capsnet
    ...
    if Num_classes ==3:
        ...
        if dataset_choose=='1d':
            ...
            train_loader,val_loader =two_class_dataloader(natural_train_path_0=base_path+'/processed_data/'+dataset_choose+'/natural_train_MFCC.pt',
                                            ...
                                            batch_size=Batch_size,validation_percentage=Validation_percentage)
    # 定义交叉熵损失函数
    if model_choose in ['cnn_capsnet', 'res_capsnet', 'seres_capsnet', 'cct_capsnet', 'res18_capsnet', 'gra_capsnet','cbam_capsnet','cbamres_capsnet']:
